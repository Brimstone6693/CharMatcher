...
from modules.Tag_Hierarch.core.config import (
    DEP_TYPES, DEP_COLORS, STATUS_COLORS, BASE_WEIGHTS,
    get_status_weight, calculate_constraint_strength
)

# GUI импортируется лениво
__all__ = [
    'Element', 'ItemList', 'ListManager',
    'DEP_TYPES', 'DEP_COLORS', 'STATUS_COLORS', 'BASE_WEIGHTS',
    'get_status_weight', 'calculate_constraint_strength',
    'ListManagerApp', 'main'
]
...
def __getattr__(name):
    ...
    if name == 'main':
        from modules.Tag_Hierarch.gui.main_app import main
        return main
